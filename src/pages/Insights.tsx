...
const patterns = [
  { id: 1, icon: '🌅', title: 'Manhãs mais calmas', description: 'Você tende a se sentir mais calmo nas manhãs.' },
  { id: 2, icon: '📈', title: 'Melhoria consistente', description: 'Sua alegria aumentou 15% nas últimas 2 semanas.' },
  { id: 3, icon: '🧘', title: 'Meditação ajuda', description: 'Após meditar, sua calma aumenta em média 30%.' },
];
